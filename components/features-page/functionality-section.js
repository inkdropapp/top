    ...
    return (
      <Article className='functionality-section'>
        ...
        <header>
          ...
          <p>Robust, clean features that let you focus on taking notes that sync across computers</p>
        </header>
              ...
              <div className='five wide column usability-description-column'>
                <div className='usability-description-block'>
                  ...
                  <div className='feature-description'>
                    Notebooks can be nested, meaning you can create a sub-notebook inside the notebook.
                    You can also add tags to a note.
                    These features are useful to organize notes based on projects and topics.
                  </div>
                  ...
                  <div className='feature-description'>
                    <p>
                      ...
                      Inkdrop&apos;s full-text search also supports filtering notebooks and tags
          ...
          <div className='ui container'>
            <div className='ui stackable centered grid sixteen column'>
              ...
              <div className='ten wide column'>
                ...
                <div className='feature-description'>
                  <p>
                    Inkdrop stores your data locally so you don&apos;t need to wait for
                    the server response on every action.
                    You can access any notes even offline.
                  </p>
                </div>
                ...
                <div className='feature-description'>
                  <p>
                    Capture a note once, and it’s instantly available
                    on all your computers.
                    The app automatically syncs notes across computers
                    when you install Inkdrop on another computer.
                    Never worry about where you saved a note because it’s in Inkdrop.
                  </p>
