    ...
    <section className="faq-section">
      <div className="ui container">
          ...
          <div className="row">
            <div className="column">
              ...
              <p>
                ...
                doesn&apos;t work for long-running business. The sustainability
                is crucial especially for note-taking apps because you will
                store a lot of notes in them day by day.
              </p>
            </div>
            <div className="column">
              ...
              <p>
                ...
                We believe it would improve your work worth over $5. This is the
                price we would pay as a user.
              </p>
            </div>
            <div className="column">
        ...
        <p className="right aligned">
          ...
          <OutboundLink href="https://hackernoon.com/why-inkdrop-is-a-subscription-app-beda29c507d5">
            our blog post
          </OutboundLink>{' '}
          for more detail.
        </p>
