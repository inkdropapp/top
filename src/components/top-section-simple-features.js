...
const SectionSimpleFeatures = () => {
  ...
  return (
    <SectionSecond id="simple-features" hasSeparator>
      ...
      <div className="ui stackable three column grid">
        <div className="column">
          ...
          <p>
            It comes with multi-language code highlighting, multi-cursors, line
            numbers, scrolling beyond the last line, showing invisible
            characters and more.
          </p>
        </div>
        <div className="column">
        ...
        <div className="column">
          ...
          <p>
            ...
            . It also supports exporting as HTML, PDF and Markdown file format.
          </p>
        </div>
        <div className="column">
          <GatsbyImage
          ...
          <p>
            Whenever, even while in offline, you can read and write notes. Just
            open up the app, then it will be instantly ready for you to start
            jotting down before you forget the idea.
          </p>
        </div>
      </div>
    </SectionSecond>
